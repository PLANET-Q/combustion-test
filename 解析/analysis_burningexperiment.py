...
firingpressure_not0 = pqmaindata[:, 1] * inclination_calibration_coefficient_firing + intercept_calibration_coefficient_firing
tankpressure_not0 = pqmaindata[:, 2] * inclination_calibration_coefficient_tank + intercept_calibration_coefficient_tank
